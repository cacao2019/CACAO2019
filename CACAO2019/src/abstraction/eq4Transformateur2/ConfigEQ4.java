...
public class ConfigEQ4 {
	...
	// Quantités initiales
	protected static final double SOLDE_INITIAL = 500_000;
	...
	protected static final double MARGE_VISEE = 2.0; // 200% // Marge que l'on tente de faire par rapport au coût de production
